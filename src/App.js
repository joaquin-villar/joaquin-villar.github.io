      ...
      <section className="hero" id="hero">
        <div className="hero-content">
          ...
          <div className="hero-right">
            ...
            <a href="https://github.com/joaquinvillar" target="_blank" rel="noopener noreferrer" className="profile-icon bottom-right">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="container">
          ...
          <div className="projects-grid">
            <div className="project-card animate">
              <a href="https://joaquinvillar.github.io" target="_blank" rel="noopener noreferrer" className="github-icon-link">
